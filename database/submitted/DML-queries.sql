...
INSERT INTO BookTrackers(wishlist_id, book_id) VALUES ((SELECT wishilst_id FROM Wishlists WHERE wishlist_name = :wishlist_name_input AND customer_id = (SELECT customer_id FROM Customers where username = :username_input)), :book_id_to_add)
